...
import styles from './EditMedicalHistory.module.css'
...
export default function EditMedicalHistory() {
  ...
  let{editMedicalHistory,showMedicalHistory} = useContext(DoctorContext)
  ...
  async function updateMedicalHistory(id,values){
    setLoading(true)
   let {data} = await editMedicalHistory(id,values)
  ...
  onSubmit:((values)=>{
    updateMedicalHistory(param.id,values)
  })
  })
