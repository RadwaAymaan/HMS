...
export default function PharmacistDetails() {
  ...
  async function viewDetails(id){
    ...
    setDetails(data.pharmacist)
    setuserData(data.pharmacist.userId)
  ...
  <div className="h-75 bg-opacity-75 bg-light mt-5 m-auto p-1">
      ...
      <div className="w-50 p-2 m-auto  text-center mt-5">
         ...
         <button onClick={()=>{
          navigate(`/Admin/EditPharmacist/${parmas.id}`)
         }}   className='btn  btn-outline-primary fw-bold text-black'>Edit Pharmacist</button>
          </div>  
